...
my %cf;
#┌─────────────────────────────────
#│ CLIP-MAIL : init2.cgi - 2015/02/28
#│ copyright (c) KentWeb, 1997-2015
#│ http://www.kent-web.com/
#└─────────────────────────────────
$cf{version} = 'clipmail2 v5.02';
#┌─────────────────────────────────
#│ [注意事項]
...
# 送信先メールアドレス
$cf{mailto} = 'info@ikebana-atrium.com, yasuka_o@ikebana-atrium.com, yutaka@dosquat.com';
...
# メールタイトル
$cf{subject} = 'FlowerJapan 2018 | 作品タイトルフォーム';
...
# 返信向けメールタイトル
$cf{sub_reply} = 'FlowerJapan 2018 | 作品タイトルフォーム にご協力いただきありがとうございます';

# 本体プログラム【URLパス】
$cf{mail_cgi} = './clipmail2.cgi';

# 管理プログラム【URLパス】
$cf{admin_cgi} = './admin2.cgi';

# ログファイル【サーバパス】
$cf{logfile} = './data2/log.cgi';

# セッションファイル【サーバパス】
$cf{sesfile} = './data2/ses.cgi';
